# 2026-06-17-1651-after-hours-autopilot
...
- Alpaca core: `wiki/evidence-store/sources/2026-06-17-1651-after-hours-autopilot-alpaca-core-preflight.json`
- Research MCP: `wiki/evidence-store/sources/2026-06-17-1651-after-hours-autopilot-research-mcp-preflight.json`
- Runtime continuity: `wiki/evidence-store/sources/2026-06-17-1651-after-hours-autopilot-runtime-alpaca-spot-check.json`
- Gate evaluation: `wiki/evidence-store/sources/2026-06-17-1651-after-hours-autopilot-after-hours-gate-evaluation.json`
...
- Regular market: closed (scheduler-owned `get_clock.timestamp=2026-06-17T03:51:09.365525195-04:00`)
- Account:
  - source-of-record 기준 account `ACTIVE`, portfolio value `101,310.49 USD`, cash `30,391.80 USD`, buying power `304,324.85 USD`
  - live continuity 기준 portfolio value `101,314.75 USD`, cash `30,391.80 USD`, buying power `304,336.78 USD`
...
- Overnight continuity quote는 `PFE 25.99/26.13`, `RGTI 21.05/21.08`, `QQQ 735.53/735.91`로 재확인했지만, budget gate가 이미 닫혀 있어 새로운 quote/spread submit boundary를 열지는 않았다.

## Validators

- `PATH=/usr/local/bin:$PATH python3 scripts/check-universe-coverage.py --strict --json wiki/evidence-store/run-manifests/2026-06-17-1651-after-hours-autopilot.json`
- `PATH=/usr/local/bin:$PATH python3 scripts/check-mcp-coverage.py --strict --json wiki/evidence-store/run-manifests/2026-06-17-1651-after-hours-autopilot.json`
- `PATH=/usr/local/bin:$PATH python3 scripts/check-risk-policy.py --json wiki/trade-ledger/orders/2026-06-17-1651-after-hours-autopilot.json`

## Artifacts

- Report: `wiki/current-runs/daily/2026-06-17-1651-after-hours-autopilot.md`
- Manifest: `wiki/evidence-store/run-manifests/2026-06-17-1651-after-hours-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-17-1651-after-hours-autopilot.json`
- Gate evaluation: `wiki/evidence-store/sources/2026-06-17-1651-after-hours-autopilot-after-hours-gate-evaluation.json`
- Runtime continuity: `wiki/evidence-store/sources/2026-06-17-1651-after-hours-autopilot-runtime-alpaca-spot-check.json`
- Post-trade snapshot: `wiki/trade-ledger/positions/2026-06-17-1651-after-hours-autopilot-post-trade.json`
