# 2026-06-02-0331-hourly-autopilot scheduled paper autopilot

## 요약

- 워크플로우: `harness/workflows/hourly-autopilot.md` 정규장 scheduled paper autopilot.
- Paper mode: `.env`에서 `ALPACA_PAPER_TRADE=true` 확인.
- 시장 상태: Alpaca scheduler preflight 기준 2026-06-01T14:31:09.434956562-04:00 정규장 열림, next_close 2026-06-01T16:00:00-04:00.
- 계좌 상태: portfolio value $103,537.04, cash $34,339.00, invested ratio 66.83%, 보유 포지션 32개.
...
| Alpaca core | PASS | scheduler preflight가 clock/account/positions/open orders/recent activities/quotes 모두 pass; quote row 2026-06-01T18:31:31Z 기준 사용 |
...
- NKE/GOOGL/AMZN: validation lifecycle pending review와 portfolio-fit 조건 때문에 add 보류.
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-02-0331-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-02-0331-hourly-autopilot.json`
- Position snapshot: `wiki/trade-ledger/positions/2026-06-02-0331-hourly-autopilot-post-trade.json`
- Source refs: `wiki/evidence-store/sources/2026-06-02-0331-hourly-autopilot-stale-order-cleanup.json`, `wiki/evidence-store/sources/2026-06-02-0331-hourly-autopilot-alpaca-core-preflight.json`, `wiki/evidence-store/sources/2026-06-02-0331-hourly-autopilot-research-mcp-preflight.json`
