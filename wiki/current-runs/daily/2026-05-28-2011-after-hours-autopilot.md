---
id: 2026-05-28-2011-after-hours-autopilot
date: 2026-05-28
workflow: after-hours-autopilot
session: after_hours
---

# 2026-05-28 20:11 KST after-hours autopilot
...
주문 제출 없음. Scheduler-owned Alpaca core preflight 기준 regular market clock은 `2026-05-28T07:11:15.247041678-04:00`에 `is_open=false`였고, fresh Alpaca MCP clock도 `2026-05-28T07:12:44.45909527-04:00`에 `is_open=false`였다. After-hours workflow에서는 preflight의 `first_blocking_gate=market_closed`를 예상된 비차단 상태로 처리했다.
...
- Order plan: `wiki/trade-ledger/orders/2026-05-28-2011-after-hours-autopilot.json`
- Manifest: `wiki/evidence-store/run-manifests/2026-05-28-2011-after-hours-autopilot.json`
- Alpaca core preflight: `wiki/evidence-store/sources/2026-05-28-2011-after-hours-autopilot-alpaca-core-preflight.json`
- Research MCP preflight: `wiki/evidence-store/sources/2026-05-28-2011-after-hours-autopilot-research-mcp-preflight.json`
