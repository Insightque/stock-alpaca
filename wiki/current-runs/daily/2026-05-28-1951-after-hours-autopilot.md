# 2026-05-28 19:51 KST after-hours autopilot
...
주문 제출 없음. Scheduler-owned Alpaca core preflight 기준 regular market clock은 `2026-05-28T06:51:13.762012891-04:00`에 `is_open=false`였고, fresh Alpaca MCP clock도 `2026-05-28T06:52:20.252922426-04:00`에 `is_open=false`였다. After-hours workflow에서는 preflight의 `first_blocking_gate=market_closed`를 예상된 비차단 상태로 처리했다.
...
- Order plan: `wiki/trade-ledger/orders/2026-05-28-1951-after-hours-autopilot.json`
- Manifest: `wiki/evidence-store/run-manifests/2026-05-28-1951-after-hours-autopilot.json`
- Alpaca core preflight: `wiki/evidence-store/sources/2026-05-28-1951-after-hours-autopilot-alpaca-core-preflight.json`
- Research MCP preflight: `wiki/evidence-store/sources/2026-05-28-1951-after-hours-autopilot-research-mcp-preflight.json`
