# 2026-05-30-0811-after-hours-autopilot
...
- Regular market not open: PASS. Alpaca clock은 `2026-05-29T19:13:31.987664895-04:00` 기준 `is_open=false`다.
- Alpaca core: PASS for after-hours interpretation. Scheduler preflight의 `first_blocking_gate=market_closed`는 장외 workflow에서 예상된 비차단 상태로 처리했다. Scheduler account/positions/orders/assets/quotes rows는 사용 가능했고, runtime Alpaca MCP도 clock/account/positions/open orders/overnight quotes를 확인했다.
...
- Quote freshness: FAIL. 후보 overnight quote timestamp가 모두 `2026-05-29T08:00:00Z` 부근이고, runtime 기준 약 913.5분 old라 after-hours 5분 한도를 초과했다.
...
- Manifest: `wiki/evidence-store/run-manifests/2026-05-30-0811-after-hours-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-05-30-0811-after-hours-autopilot.json`
- Runtime Alpaca spot check: `wiki/evidence-store/sources/2026-05-30-0811-after-hours-autopilot-runtime-alpaca-spot-check.json`
- Scheduler Alpaca preflight: `wiki/evidence-store/sources/2026-05-30-0811-after-hours-autopilot-alpaca-core-preflight.json`
- Scheduler research preflight: `wiki/evidence-store/sources/2026-05-30-0811-after-hours-autopilot-research-mcp-preflight.json`
