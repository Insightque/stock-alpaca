# 2026-05-30-1531-after-hours-autopilot
...
- Scheduler Alpaca core preflight: `wiki/evidence-store/sources/2026-05-30-1531-after-hours-autopilot-alpaca-core-preflight.json`
- Scheduler research MCP preflight: `wiki/evidence-store/sources/2026-05-30-1531-after-hours-autopilot-research-mcp-preflight.json`
- Runtime Alpaca MCP spot-check: `wiki/evidence-store/sources/2026-05-30-1531-after-hours-autopilot-runtime-alpaca-spot-check.json`
...
- quote freshness: FAIL. QQQ overnight quote timestamp `2026-05-29T08:00:00.386377592Z`는 의사결정 시점 기준 약 1353.2분 경과해 `after_hours_policy.max_quote_age_minutes_submit=5.0`을 초과했다.
- spread gate: stale quote 때문에 주문 제출 gate로 평가하지 않음

## 주문 및 reconcile

- 주문 계획: `wiki/trade-ledger/orders/2026-05-30-1531-after-hours-autopilot.json`
