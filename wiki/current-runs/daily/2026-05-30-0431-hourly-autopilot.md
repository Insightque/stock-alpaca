# 2026-05-30-0431-hourly-autopilot scheduled paper autopilot

## 요약

- 세션: regular paper submit workflow, Alpaca clock `2026-05-29T15:31:07.802595101-04:00` 기준 시장 open.
...
| market clock | PASS | `2026-05-29T15:31:07.802595101-04:00`, regular session open |
| stale order cleanup | PASS | `wiki/evidence-store/sources/2026-05-30-0431-hourly-autopilot-stale-order-cleanup.json` |
| Alpaca core | PASS | `wiki/evidence-store/sources/2026-05-30-0431-hourly-autopilot-alpaca-core-preflight.json` |
...
| Symbol | 보유수량 | 진단 | 결정 |
| --- | ---: | --- | --- |
| AMD | 14 | AI semiconductor target-band warning area이나 active trim trigger 미확인 | watch |
...
| Symbol | 상태 | 제외 사유 |
| --- | --- | --- |
| BAC | watch | same-session validation exposure와 portfolio-fit 우위 부족 |
| FCX | watch | commodity cluster 노출과 최근 validation exposure 고려 |
| SO | watch | 최근 utility/defensive validation exposure 중복 회피 |
...
주문 계획: `wiki/trade-ledger/orders/2026-05-30-0431-hourly-autopilot.json`
