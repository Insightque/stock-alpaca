# 2026-05-30-0451-hourly-autopilot scheduled paper autopilot

## 요약

- 세션: regular paper submit workflow, Alpaca clock `2026-05-29T15:51:12.139020799-04:00` 기준 시장 open.
...
| market clock | PASS | `2026-05-29T15:51:12.139020799-04:00`, regular session open |
| stale order cleanup | PASS | `wiki/evidence-store/sources/2026-05-30-0451-hourly-autopilot-stale-order-cleanup.json` |
| Alpaca core | PASS | `wiki/evidence-store/sources/2026-05-30-0451-hourly-autopilot-alpaca-core-preflight.json` |
...
| Symbol | 보유수량 | 진단 | 결정 |
| --- | ---: | --- | --- |
| AMD | 14 | AI semiconductor target-band warning area이나 active trim trigger 미확인; quote spread gate도 불리 | watch |
| PLTR | 1 | 수익 상태지만 overheat reversal trigger 없고 spread gate 초과 | watch |
...
주문 계획: `wiki/trade-ledger/orders/2026-05-30-0451-hourly-autopilot.json`
