...
| Market clock | PASS | scheduler Alpaca preflight clock `2026-06-03T10:11:08.969234064-04:00`, regular market open |
| Stale order cleanup | PASS | `wiki/evidence-store/sources/2026-06-03-2311-hourly-autopilot-stale-order-cleanup.json`에서 blocking autopilot open order 없음 |
...
| Quote/spread | MIXED | SPY/QQQ/BAC/AMZN/NKE/NOK/TSLA/NEE는 pass, SO는 spread fail |
...
| BAC | watch | 0.0386% | 금융 분산 후보지만 rate-sensitive positive thesis는 FRED macro row 실패 때문에 watch로 강등했다. |
| AMZN | watch | 0.0236% | 기존 mega-cap quality hold 대비 replacement-rank와 portfolio contribution 우위가 부족했다. |
...
| Symbol | 판단 | Gate | 설명 |
| --- | --- | --- | --- |
| TSLA | watch | held_quantity_and_metric_gap | spread는 0.0442%로 정상화됐지만 1주 보유라 25% trim 규칙을 만족하는 부분 축소가 어렵고 decision-grade expected-excess가 비어 있다. |
...
| NEE | hold/watch | decision_grade_metric_and_macro_gap | spread 0.0349%는 통과권이지만 FRED 429와 decision-grade expected-excess 공백으로 trim justification이 부족했다. |
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-03-2311-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-03-2311-hourly-autopilot.json`
- Post-trade snapshot: `wiki/trade-ledger/positions/2026-06-03-2311-hourly-autopilot-post-trade.json`
- Source refs: `wiki/evidence-store/sources/2026-06-03-2311-hourly-autopilot-stale-order-cleanup.json`, `wiki/evidence-store/sources/2026-06-03-2311-hourly-autopilot-alpaca-core-preflight.json`, `wiki/evidence-store/sources/2026-06-03-2311-hourly-autopilot-research-mcp-preflight.json`
