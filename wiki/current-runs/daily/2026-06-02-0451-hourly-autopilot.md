# 2026-06-02-0451-hourly-autopilot scheduled paper autopilot

## 요약

- 워크플로우: `harness/workflows/hourly-autopilot.md` 정규장 scheduled paper autopilot.
- Paper mode: `.env`에서 `ALPACA_PAPER_TRADE=true` 확인.
- 시장 상태: Alpaca scheduler preflight 기준 2026-06-01T15:51:11.835915157-04:00 정규장 열림, next_close 2026-06-01T16:00:00-04:00.
- 계좌 상태: portfolio value $103,122.48, cash $34,339.00, invested ratio 66.70%, 보유 포지션 32개.
...
| Alpaca core | PASS | scheduler preflight가 clock/account/positions/open orders/recent activities/quotes 모두 pass; quote row 2026-06-01T19:51:29.342438511Z 기준 사용 |
...
- NKE/WMT: validation lifecycle pending review와 portfolio-fit 조건 때문에 add 보류.
- NVDA: SEC/Firecrawl/Yahoo 근거는 usable/pass지만 AI semiconductor cluster target-band 제약 때문에 신규 same-cluster 노출 보류.
- CVX: energy exposure가 이미 여러 보유 종목으로 표현되어 replacement-rank 개선 없이 추가하지 않았다.
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-02-0451-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-02-0451-hourly-autopilot.json`
- Position snapshot: `wiki/trade-ledger/positions/2026-06-02-0451-hourly-autopilot-post-trade.json`
- Source refs: `wiki/evidence-store/sources/2026-06-02-0451-hourly-autopilot-stale-order-cleanup.json`, `wiki/evidence-store/sources/2026-06-02-0451-hourly-autopilot-alpaca-core-preflight.json`, `wiki/evidence-store/sources/2026-06-02-0451-hourly-autopilot-research-mcp-preflight.json`
