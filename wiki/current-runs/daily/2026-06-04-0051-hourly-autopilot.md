...
| Market clock | PASS | scheduler Alpaca preflight clock `2026-06-03T11:51:12.188552183-04:00`, regular market open |
| Stale order cleanup | PASS | `wiki/evidence-store/sources/2026-06-04-0051-hourly-autopilot-stale-order-cleanup.json`에서 blocking autopilot open order 없음 |
...
| Quote/spread | MIXED | SPY/QQQ/BAC/NKE/PLTR/NOK/TSLA/NEE는 pass, SO는 spread fail, sell/trim은 decision-grade metric gate가 남았다 |
...
| NKE | watch | 0.0230% | 최근 weak validation review와 기존 held exposure 대비 replacement-rank 개선이 부족했다. |
| PLTR | watch | 0.0278% | speculative-growth validation hold는 유지하지만 새 add를 정당화할 portfolio construction 우위가 부족했다. |
| NOK | blocked add | 0.0586% | 기존 큰 보유와 due 5D validation review 때문에 explicit add discipline을 유지했다. |

## Sell/Trim 진단

| Symbol | 판단 | Gate | 설명 |
| --- | --- | --- | --- |
| TSLA | watch | held_quantity_and_metric_gap | spread는 0.0329%로 통과권이지만 1주 보유라 25% trim 규칙을 whole-share로 만족시키기 어렵고 decision-grade expected-excess가 비어 있다. |
| SO | watch | spread_and_decision_grade_metric_gap | spread 1.1325%가 정책 상한 0.50%를 넘었고 FRED 429와 decision-grade expected-excess 공백이 남아 trim 주문으로 올리지 않았다. |
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-04-0051-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-04-0051-hourly-autopilot.json`
- Post-trade snapshot: `wiki/trade-ledger/positions/2026-06-04-0051-hourly-autopilot-post-trade.json`
- Source refs: `wiki/evidence-store/sources/2026-06-04-0051-hourly-autopilot-stale-order-cleanup.json`, `wiki/evidence-store/sources/2026-06-04-0051-hourly-autopilot-alpaca-core-preflight.json`, `wiki/evidence-store/sources/2026-06-04-0051-hourly-autopilot-research-mcp-preflight.json`
