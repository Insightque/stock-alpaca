# 2026-05-30-0331-hourly-autopilot scheduled paper autopilot

## 요약

- 세션: regular paper submit workflow, Alpaca clock `2026-05-29T14:31:08.002711754-04:00` 기준 시장 open.
...
- Validators: universe PASS, MCP PASS, risk PASS(expected warning `orders is empty`). 주문 계획은 empty-order이며 현재 32개 position을 포함한다.
...
| market clock | PASS | `2026-05-29T14:31:08.002711754-04:00`, regular session open |
| stale order cleanup | PASS | `wiki/evidence-store/sources/2026-05-30-0331-hourly-autopilot-stale-order-cleanup.json` |
| Alpaca core | PASS | `wiki/evidence-store/sources/2026-05-30-0331-hourly-autopilot-alpaca-core-preflight.json` |
...
| Symbol | 상태 | 제외 사유 |
| --- | --- | --- |
| SBUX | watch | spread는 통과하지만 maintained thesis evidence와 same-session 후보 우선순위 부족 |
| CAT | watch | spread gate 초과 |
| CVX | watch | spread gate 초과 및 신규 노출 우선순위 부족 |
...
주문 계획: `wiki/trade-ledger/orders/2026-05-30-0331-hourly-autopilot.json`
