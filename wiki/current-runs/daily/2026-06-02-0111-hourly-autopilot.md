# 2026-06-02-0111-hourly-autopilot scheduled paper autopilot

## 요약

- 워크플로우: `harness/workflows/hourly-autopilot.md` 정규장 scheduled paper autopilot.
- Paper mode: `.env`에서 `ALPACA_PAPER_TRADE=true` 확인.
- 시장 상태: Alpaca scheduler preflight 기준 2026-06-01T12:11:12.233007636-04:00 정규장 열림, next_close 2026-06-01T16:00:00-04:00.
- 계좌 상태: portfolio value $103,038.75, cash $34,339.00, invested ratio 66.67%, 보유 포지션 32개.
...
| Research MCP | PASS | SEC EDGAR, Firecrawl, Yahoo usable/pass 3개 확인; Alpha/FRED provider_error는 gap으로 기록 |
...
| NEE | hold/watch | decision_grade_metric_and_macro_gap | 1주 trim 수량은 가능하나 rate-sensitive macro/decision metric 공백 |

## 신규 Buy 후보

- BAC/JPM: rate-sensitive thesis가 FRED macro/rates 확인 공백 때문에 watch로 강등.
- AMZN/NKE/GOOGL: review backlog throttle, lifecycle pending review, replacement rank/portfolio contribution 조건이 신규 노출을 정당화하지 못함.
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-02-0111-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-02-0111-hourly-autopilot.json`
- Position snapshot: `wiki/trade-ledger/positions/2026-06-02-0111-hourly-autopilot-post-trade.json`
- Source refs: `wiki/evidence-store/sources/2026-06-02-0111-hourly-autopilot-stale-order-cleanup.json`, `wiki/evidence-store/sources/2026-06-02-0111-hourly-autopilot-alpaca-core-preflight.json`, `wiki/evidence-store/sources/2026-06-02-0111-hourly-autopilot-research-mcp-preflight.json`
