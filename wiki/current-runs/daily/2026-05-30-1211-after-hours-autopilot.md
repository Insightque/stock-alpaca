# 2026-05-30-1211-after-hours-autopilot
...
- Regular market not open: PASS. Alpaca MCP clock은 `2026-05-29T23:12:58.475674392-04:00` 기준 `is_open=false`다.
- Alpaca core: PASS for after-hours interpretation. Scheduler preflight의 `first_blocking_gate=market_closed`는 장외 workflow에서 예상된 비차단 상태로 처리했다. Scheduler account/positions/open orders/assets/quotes rows를 사용했고, runtime Alpaca MCP는 clock/account/positions/open orders/QQQ asset/overnight QQQ quote를 확인했다.
...
- Quote freshness: FAIL. Runtime QQQ overnight quote는 `2026-05-29T08:00:00.386377592Z`이고, scheduler quote evidence도 after-hours 5분 한도를 초과했다.
...
- Order-plan schema mismatch: `AGENTS.md`는 `quote_captured_at`/`asset_checked_at`를 요구하지만 현재 `harness/order-plan.schema.json`은 해당 top-level fields를 거부한다. Validator source of truth를 따라 plan에는 넣지 않고 이 mismatch를 log에 남긴다.
...
- Manifest: `wiki/evidence-store/run-manifests/2026-05-30-1211-after-hours-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-05-30-1211-after-hours-autopilot.json`
- Runtime Alpaca spot check: `wiki/evidence-store/sources/2026-05-30-1211-after-hours-autopilot-runtime-alpaca-spot-check.json`
- Scheduler Alpaca preflight: `wiki/evidence-store/sources/2026-05-30-1211-after-hours-autopilot-alpaca-core-preflight.json`
- Scheduler research preflight: `wiki/evidence-store/sources/2026-05-30-1211-after-hours-autopilot-research-mcp-preflight.json`
