---
id: 2026-05-28-2111-after-hours-autopilot
date: 2026-05-28
workflow: after-hours-autopilot
session: after_hours
---

# 2026-05-28 21:11 KST after-hours autopilot
...
주문 제출 없음. Scheduler-owned Alpaca core preflight 기준 regular market clock은 `2026-05-28T08:11:19.374108545-04:00`에 `is_open=false`였고, fresh Alpaca MCP clock도 `2026-05-28T08:13:19.470071745-04:00`에 `is_open=false`였다. After-hours workflow에서는 preflight의 `first_blocking_gate=market_closed`를 예상된 비차단 상태로 처리했다.
...
- Fresh Alpaca MCP spot checks: clock closed, account ACTIVE, positions fetched; fresh open-order call was cancelled by the runtime safety monitor, so scheduler-owned passing open-order row was used
...
- Order plan: `wiki/trade-ledger/orders/2026-05-28-2111-after-hours-autopilot.json`
- Manifest: `wiki/evidence-store/run-manifests/2026-05-28-2111-after-hours-autopilot.json`
- Alpaca core preflight: `wiki/evidence-store/sources/2026-05-28-2111-after-hours-autopilot-alpaca-core-preflight.json`
- Research MCP preflight: `wiki/evidence-store/sources/2026-05-28-2111-after-hours-autopilot-research-mcp-preflight.json`
