# 2026-06-02-0411-hourly-autopilot scheduled paper autopilot

## 요약

- 워크플로우: `harness/workflows/hourly-autopilot.md` 정규장 scheduled paper autopilot.
- Paper mode: `.env`에서 `ALPACA_PAPER_TRADE=true` 확인.
- 시장 상태: Alpaca scheduler preflight 기준 2026-06-01T15:11:07.79050328-04:00 정규장 열림, next_close 2026-06-01T16:00:00-04:00.
- 계좌 상태: portfolio value $103,443.84, cash $34,339.00, invested ratio 66.80%, 보유 포지션 32개.
...
| Alpaca core | PASS | scheduler preflight가 clock/account/positions/open orders/recent activities/quotes 모두 pass; quote row 2026-06-01T19:11:26.966453102Z 기준 사용 |
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-02-0411-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-02-0411-hourly-autopilot.json`
- Position snapshot: `wiki/trade-ledger/positions/2026-06-02-0411-hourly-autopilot-post-trade.json`
- Source refs: `wiki/evidence-store/sources/2026-06-02-0411-hourly-autopilot-stale-order-cleanup.json`, `wiki/evidence-store/sources/2026-06-02-0411-hourly-autopilot-alpaca-core-preflight.json`, `wiki/evidence-store/sources/2026-06-02-0411-hourly-autopilot-research-mcp-preflight.json`
