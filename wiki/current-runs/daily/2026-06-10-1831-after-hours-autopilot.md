# 2026-06-10-1831-after-hours-autopilot
...
- Alpaca core: `wiki/evidence-store/sources/2026-06-10-1831-after-hours-autopilot-alpaca-core-preflight.json`
- Research MCP: `wiki/evidence-store/sources/2026-06-10-1831-after-hours-autopilot-research-mcp-preflight.json`
...
- Regular market: scheduler preflight 기준 closed (`timestamp=2026-06-10T05:31:07.219414754-04:00`, `next_open=2026-06-10T09:30:00-04:00`); runtime Alpaca MCP `get_clock`도 `timestamp=2026-06-10T05:32:53.220601231-04:00`로 여전히 closed였다.
- Account/positions: runtime `get_account_info/get_all_positions` cross-check에서는 account `ACTIVE`, portfolio value `97,899.54 USD`, cash `31,368.63 USD`, buying power `296,588.09 USD`, positions `33`건이 유지됐다.
...
- Scheduler-owned submit boundary evidence: `1831` Alpaca core preflight는 broad universe `62` symbols에 대해 asset/quote/snapshot rows를 pass로 남겼고, 이번 cycle은 separate session budget blocker 때문에 submit path에 진입하지 않았다.
...
- `PATH=/usr/local/bin:$PATH python3 scripts/check-universe-coverage.py --strict --json wiki/evidence-store/run-manifests/2026-06-10-1831-after-hours-autopilot.json`
  - 결과: PASS
- `PATH=/usr/local/bin:$PATH python3 scripts/check-mcp-coverage.py --strict --json wiki/evidence-store/run-manifests/2026-06-10-1831-after-hours-autopilot.json`
  - 결과: PASS
- `PATH=/usr/local/bin:$PATH python3 scripts/check-risk-policy.py --json wiki/trade-ledger/orders/2026-06-10-1831-after-hours-autopilot.json`
  - 결과: PASS
  - 경고: `orders is empty`

## Artifacts

- Manifest: `wiki/evidence-store/run-manifests/2026-06-10-1831-after-hours-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-10-1831-after-hours-autopilot.json`
- Gate evaluation source: `wiki/evidence-store/sources/2026-06-10-1831-after-hours-autopilot-after-hours-gate-evaluation.json`
- Post-trade snapshot: `wiki/trade-ledger/positions/2026-06-10-1831-after-hours-autopilot-post-trade.json`
