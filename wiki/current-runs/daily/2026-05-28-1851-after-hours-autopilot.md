# 2026-05-28 18:51 KST after-hours autopilot
...
주문 제출 없음. Scheduler-owned Alpaca core preflight 기준 regular market clock은 `2026-05-28T05:51:15.386028913-04:00`에 `is_open=false`였고, after-hours workflow에서는 `first_blocking_gate=market_closed`를 예상된 비차단 상태로 처리했다.
...
- Order plan: `wiki/trade-ledger/orders/2026-05-28-1851-after-hours-autopilot.json`
- Manifest: `wiki/evidence-store/run-manifests/2026-05-28-1851-after-hours-autopilot.json`
- Alpaca core preflight: `wiki/evidence-store/sources/2026-05-28-1851-after-hours-autopilot-alpaca-core-preflight.json`
- Research MCP preflight: `wiki/evidence-store/sources/2026-05-28-1851-after-hours-autopilot-research-mcp-preflight.json`
