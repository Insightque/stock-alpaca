# 2026-06-01-1251-after-hours-autopilot
...
이번 실행은 Alpaca 정규장이 닫힌 상태에서 장외 workflow로 진행했다. Scheduler-owned Alpaca core preflight의 `first_blocking_gate=market_closed`는 장외 실행에서 예상된 상태라 단독 차단 사유로 보지 않았다. 같은 preflight와 런타임 Alpaca MCP spot-check로 account, positions, open orders, prior after-hours order history, QQQ asset, overnight quote/spread를 확인했다.
...
| quote/spread | PASS BUT NOT ACTIONABLE | QQQ overnight quote fresh, spread 약 0.0067%; 예산 소진으로 신규 후보 없음 |
...
- Manifest: `wiki/evidence-store/run-manifests/2026-06-01-1251-after-hours-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-06-01-1251-after-hours-autopilot.json`
- Gate evaluation: `wiki/evidence-store/sources/2026-06-01-1251-after-hours-autopilot-after-hours-gate-evaluation.json`
- Scheduler Alpaca preflight: `wiki/evidence-store/sources/2026-06-01-1251-after-hours-autopilot-alpaca-core-preflight.json`
- Scheduler research preflight: `wiki/evidence-store/sources/2026-06-01-1251-after-hours-autopilot-research-mcp-preflight.json`
