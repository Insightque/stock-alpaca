# 2026-05-29 06:11 KST after-hours autopilot
...
`ALPACA_PAPER_TRADE=true`를 확인했다. Scheduler-owned Alpaca core preflight 기준 Alpaca 정규장은 `2026-05-28T17:11:15.825265098-04:00`에 닫혀 있었고, after-hours workflow의 "정규장 open이면 제출 금지" 조건과 충돌하지 않았다.

## 사용한 소스

- Scheduler Alpaca core preflight: `wiki/evidence-store/sources/2026-05-29-0611-after-hours-autopilot-alpaca-core-preflight.json`
- Scheduler research MCP preflight: `wiki/evidence-store/sources/2026-05-29-0611-after-hours-autopilot-research-mcp-preflight.json`
- Fresh Alpaca MCP spot checks: `get_account_info`, `get_all_positions`, `get_orders(status=open)`, `get_stock_latest_quote`, `get_account_activities`
...
- Account: PASS, `ACTIVE`, portfolio value `102370.34`, buying power `133349.26`
...
| NOK | skip | quote freshness gate 실패 |
| SPY | skip | quote freshness gate 실패, 1주 notional이 after-hours validation cap 초과 |
...
- Order plan: `wiki/trade-ledger/orders/2026-05-29-0611-after-hours-autopilot.json`
- Run manifest: `wiki/evidence-store/run-manifests/2026-05-29-0611-after-hours-autopilot.json`
