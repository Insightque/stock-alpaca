# 2026-05-30-0251-hourly-autopilot
...
| Market clock | PASS from scheduler preflight | Alpaca clock 2026-05-29T13:51:10.527615291-04:00 open |
| Alpaca core MCP | PASS | `wiki/evidence-store/sources/2026-05-30-0251-hourly-autopilot-alpaca-core-preflight.json`; clock/account/positions/open orders/recent activities/quotes pass |
| Stale order cleanup | PASS | `wiki/evidence-store/sources/2026-05-30-0251-hourly-autopilot-stale-order-cleanup.json`; stale candidates 0, remaining open orders 0 |
...
- Portfolio value: $101,547.50
- Cash: $34,800.26
- Long market value: $66,747.24
- Invested ratio: 65.73%
- Open orders: 0
- Positions captured: 32

## 산출물

- Manifest: `wiki/evidence-store/run-manifests/2026-05-30-0251-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-05-30-0251-hourly-autopilot.json`
- Position/open-order snapshot: `wiki/trade-ledger/positions/2026-05-30-0251-hourly-autopilot-post-trade.json`
- Scheduler cleanup: `wiki/evidence-store/sources/2026-05-30-0251-hourly-autopilot-stale-order-cleanup.json`
- Alpaca core preflight: `wiki/evidence-store/sources/2026-05-30-0251-hourly-autopilot-alpaca-core-preflight.json`
- Research preflight: `wiki/evidence-store/sources/2026-05-30-0251-hourly-autopilot-research-mcp-preflight.json`
