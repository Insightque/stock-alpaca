---
id: 2026-05-29-0211-hourly-autopilot
created_at: 2026-05-28T17:13:00Z
workflow: hourly-autopilot
paper: true
---

# 2026-05-29 02:11 KST 정규장 hourly autopilot

## 실행 요약

- 실행 ID: `2026-05-29-0211-hourly-autopilot`
- 모드: `submit`, paper only
- 시장 시계: scheduler Alpaca core preflight 기준 `2026-05-28T13:11:19.099973182-04:00` ET open, next close `2026-05-28T16:00:00-04:00`
- stale order cleanup: `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-stale-order-cleanup.json` status `pass`, stale candidate와 remaining open order 없음.
...
| 순위 | 티커 | 판단 | 핵심 근거 | 제한 |
| ---: | --- | --- | --- | --- |
| 1 | SPY | recheck_only | 시장 벤치마크 ETF, fresh Alpaca quote와 SEC/Yahoo/Firecrawl 확인 | daily new order cap 20/20 |
| 2 | QQQ | recheck_only | 성장주 벤치마크, fresh quote/research 확인 | daily new order cap 20/20 |
| 3 | AAPL | recheck_only | 대형 기술주 후보, Yahoo recommendations/news 및 SEC/Firecrawl 확인 | daily new order cap 20/20 |
| 4 | AMZN | recheck_only | 소비/클라우드 대형주 후보, research preflight 확인 | daily new order cap 20/20 |
| 5 | NEE | recheck_only | 유틸리티/방어 분산 후보, quote와 research 확인 | daily new order cap 20/20 |
| 6 | NVDA/INTC | recheck_only | AI 반도체 및 반도체 분산 후보, Alpaca asset/quote 확인 | daily new order cap 20/20 |
| 7 | COP/XOM | recheck_only | 에너지 분산 후보, SEC/Yahoo/Firecrawl 확인 | daily new order cap 20/20 |
| 8 | GOOGL/BAC/SO | recheck_only | 대형 기술/금융/유틸리티 분산 후보 | daily new order cap 20/20 |
...
| --- | --- | ---: | ---: | --- | --- |
| SPY/QQQ/AAPL/AMZN/NEE/NVDA/INTC/COP/GOOGL/BAC/SO/XOM | buy | 0 | - | skipped | `risk_daily_new_orders_budget`, same ET-session cap 20/20 |

## MCP Coverage Matrix

| MCP | queried | used_in_score | outcome | gap_category | source_refs |
| --- | --- | --- | --- | --- | --- |
| alpaca | true | true | pass | not_applicable | `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-alpaca-core-preflight.json` |
| sec-edgar | true | true | pass | not_applicable | `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-research-mcp-preflight.json` |
| alpha-vantage | true | false | gap | empty_response | `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-research-mcp-preflight.json` |
| fred | true | true | pass | not_applicable | `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-research-mcp-preflight.json` |
| firecrawl | true | true | pass | not_applicable | `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-research-mcp-preflight.json` |
| yahoo-finance | true | true | pass | not_applicable | `wiki/evidence-store/sources/2026-05-29-0211-hourly-autopilot-research-mcp-preflight.json` |
...
- Quote freshness: Alpaca quote rows are from `2026-05-28T17:11:39Z` 부근으로 submit freshness 한도 20분 이내였다.
