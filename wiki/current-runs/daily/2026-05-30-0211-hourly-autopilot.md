# 2026-05-30-0211-hourly-autopilot
...
| Market clock | PASS from scheduler preflight | Alpaca clock 2026-05-29T13:11:09.294728427-04:00 open |
| Alpaca core MCP | PASS | `wiki/evidence-store/sources/2026-05-30-0211-hourly-autopilot-alpaca-core-preflight.json`; clock/account/positions/open orders/recent activities/quotes pass |
| Stale order cleanup | PASS | `wiki/evidence-store/sources/2026-05-30-0211-hourly-autopilot-stale-order-cleanup.json`; stale candidates 0, remaining open orders 0 |
...
- Manifest: `wiki/evidence-store/run-manifests/2026-05-30-0211-hourly-autopilot.json`
- Order plan: `wiki/trade-ledger/orders/2026-05-30-0211-hourly-autopilot.json`
- Position/open-order snapshot: `wiki/trade-ledger/positions/2026-05-30-0211-hourly-autopilot-post-trade.json`
- Scheduler cleanup: `wiki/evidence-store/sources/2026-05-30-0211-hourly-autopilot-stale-order-cleanup.json`
- Alpaca core preflight: `wiki/evidence-store/sources/2026-05-30-0211-hourly-autopilot-alpaca-core-preflight.json`
- Research preflight: `wiki/evidence-store/sources/2026-05-30-0211-hourly-autopilot-research-mcp-preflight.json`
