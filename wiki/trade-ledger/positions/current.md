...
_Last updated: 2026-06-05 09:51 KST_

## 계좌 요약

- Alpaca paper account status: ACTIVE
- Portfolio value: $102,104.14
- Cash: $30,487.94
- Buying power: $252,416.64
- Long market value: $71,616.20

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-05-0951-after-hours-autopilot]]
- Open/new: 없음
- Filled: 없음
- Cancelled: 없음
- Position count observed by Alpaca MCP: 33 positions. 장외 세션에서 신규 fill, 신규 open order, 포지션 수량 변화는 없었다.
- Recent reconciliation scope: scheduler-owned `0951` Alpaca core preflight와 runtime `get_all_positions`, `get_stock_latest_quote`, `get_stock_snapshot` 기준 regular market closed와 장외 `ah-` 신규 주문 0건을 재확인했고, `QQQ`는 fresh/tight quote를 회복했지만 1주 ask가 per-order cap을 넘어서 `place_stock_order` 호출은 생략했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-05-0951-after-hours-autopilot-post-trade.json`
...
- 위 계좌 요약 수치는 `0951` scheduler core preflight account snapshot과 runtime `get_all_positions/get_stock_latest_quote/get_stock_snapshot` 보조 확인 기준이다.
