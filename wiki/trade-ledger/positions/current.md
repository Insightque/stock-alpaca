...
- Run: [[2026-07-24-2111-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-2111-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-2111-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
...
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-2111-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T12:12:39Z` account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-2111-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-2111-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24T12:12:39Z_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1951-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1951-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1951-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1951-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T10:52:46Z` account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1951-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1951-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24T10:52:46Z_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1931-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1931-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1931-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1931-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T10:33:40Z` account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1931-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1931-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 10:33:40 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1911-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1911-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1911-` source-of-record preflight `orders_submitted=0` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다. runtime `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)` continuity 호출은 user-cancelled였지만 source-of-record recent-activities row와 live empty order books가 fill parity를 유지했다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1911-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T10:13:08Z` account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1911-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1911-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 10:13:08 UTC_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1811-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T05:13:35.874782664-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1811-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1811-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 09:13:35 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1751-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1751-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1751-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1751-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T04:53:10.294536361-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1751-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1751-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 08:53:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1731-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1731-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1731-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1731-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T04:32:54.408844152-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1731-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1731-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record와 live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1631-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T03:31:08.541279282-04:00` regular market closed, watchlists `0`를 재확인했고, 추가 trade continuity 호출은 세션에서 취소돼 submit boundary로 승격하지 않았다. user requirement에 따라 `2026-07-24-1631-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1631-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 07:35 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1611-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1611-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1611-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1611-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T03:13:02.948276033-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1611-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1611-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 07:15 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1551-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1551-` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1551-` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1551-` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T02:52:37.97964898-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1551-` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1551-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 06:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1511-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1511` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1511` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1511` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T02:12:42.16326617-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1511` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1511-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 06:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1451-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1451` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `2026-07-24-1451` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1451` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T01:53:18.686933697-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `2026-07-24-1451` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1451-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 05:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1431-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1431` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1431` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1431` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T01:33:02.755979667-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `1431` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1431-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 05:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1411-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1411` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1411` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1411` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T01:13:13.102434249-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `1411` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1411-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 05:11 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1351-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1351` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1351` source-of-record preflight `orders_submitted=0` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1351` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T00:52:50.052772184-04:00` regular market closed, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `1351` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1351-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 04:51 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1331-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1331` preflight 기준 open orders `0`이다.
- Filled: 없음. `1331` source-of-record preflight `orders_submitted=0` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record와 live continuity 모두 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1331` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 현재 세션의 live Alpaca continuity는 호출 가능한 도구 범위상 `get_all_positions`, `get_watchlists`로 제한됐고 positions `31`, watchlists `0`, focus position 상태를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `1331` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1331-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 04:32 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1311-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1311` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1311` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1311` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-24T00:12:36.540731673-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight quote는 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh했다. 다만 이번 scheduled run은 user requirement에 따라 `1311` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1311-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 04:12 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1251-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1251` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1251` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1251` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T23:53:21.389428331-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight quote는 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh했다. 다만 이번 scheduled run은 user requirement에 따라 `1251` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1251-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 03:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1231-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1231` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1231` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1231` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T23:33:13.709944848-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight quote는 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh했다. 다만 이번 scheduled run은 user requirement에 따라 `1231` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1231-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 03:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1211-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1211` preflight 기준 open orders `0`이다.
- Filled: 없음. `1211` source-of-record preflight `orders_submitted=0` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1211` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `get_all_positions`와 `get_stock_latest_quote(feed=overnight)`로만 제한해 positions `31`과 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`의 fresher overnight quote를 재확인했다. 다만 이번 scheduled run은 user requirement에 따라 `1211` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1211-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 03:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1151-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1151` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1151` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1151` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T22:54:46.922710703-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight quote는 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh했다. 다만 이번 scheduled run은 user requirement에 따라 `1151` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1151-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 02:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1111-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1111` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1111` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1111` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T22:13:16.693435593-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight snapshot은 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh한 quote를 보여줬다. 다만 이번 scheduled run은 user requirement에 따라 `1111` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1111-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 02:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1051-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1051` preflight와 live `get_orders(status=open)=[]`, `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1051` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1051` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T21:52:57.602768478-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight snapshot은 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh한 quote를 보여줬다. 다만 이번 scheduled run은 user requirement에 따라 `1051` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1051-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 01:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-1031-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-1031` preflight와 live `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours open/new order는 `0`이다.
- Filled: 없음. `1031` source-of-record preflight `orders_submitted=0`과 live `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-1031` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T21:32:24.300385703-04:00` regular market closed, watchlists `0`, positions `31`, same-session after-hours orders/fills `0/0`를 재확인했고 overnight snapshot은 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh한 quote를 보여줬다. 다만 이번 scheduled run은 user requirement에 따라 `1031` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-1031-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-24 01:32 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-0951-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-0951` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: 없음. `0951` source-of-record preflight `orders_submitted=0`과 live `get_orders(status=all, after=2026-07-23T20:00:00Z)=[]` 기준 same-session after-hours submitted/fills는 `0/0`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0951` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T20:53:39.875087668-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, positions `31`을 재확인했고 overnight snapshot은 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`에서 더 fresh한 quote를 보여줬다. 다만 이번 scheduled run은 user requirement에 따라 `0951` preflight quote/spread row를 submit boundary로 유지해 first blocking gate가 `fresh_quote`로 남았고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0951-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0851` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live Alpaca continuity는 `2026-07-23T19:55:05.079378065-04:00` regular market closed, open orders `0`, watchlists `0`, positions `31`을 재확인했다. direct runtime `get_account_info/get_orders(status=all)/get_account_activities(FILL)`는 timeout이 났지만 `0851` preflight가 이미 passing account/open-order/session-count evidence와 `orders_submitted=0`을 제공하고 있어 비차단 continuity gap으로만 기록했다. separate after-hours session budget은 아직 `2/2` available이지만 first blocking gate가 `fresh_quote`로 남아 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0851-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 23:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-0811-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-0811` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: 없음. `get_orders(status=all, after=2026-07-23T20:00:00Z)` 기준 same-session after-hours submitted/fills는 `0/0`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0811` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T19:13:30.819828825-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `0/0`를 재확인했다. separate after-hours session budget은 아직 `2/2` available이지만 first blocking gate가 `fresh_quote`로 남아 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0811-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 23:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-0751-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-0751` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0751` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T18:52:59.007368383-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `0/0`를 재확인했다. separate after-hours session budget은 아직 `2/2` available이지만 first blocking gate가 `fresh_quote`로 남아 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0751-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 22:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-0731-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-0731` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: 없음. `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)`와 `get_orders(status=all, after=2026-07-23T20:00:00Z)` 기준 same-session after-hours submitted/fills는 `0/0`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0731` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T18:33:03.0532083-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `0/0`를 재확인했다. separate after-hours session budget은 아직 `2/2` available이지만 first blocking gate가 `fresh_quote`로 남아 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0731-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 22:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-0711-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-0711` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: 없음. `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)`와 `get_orders(status=all, after=2026-07-23T20:00:00Z)` 기준 same-session after-hours submitted/fills는 `0/0`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0711` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T18:13:25.210925497-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `0/0`를 재확인했다. separate after-hours session budget은 아직 `2/2` available이지만 first blocking gate가 `fresh_quote`로 남아 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0711-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 22:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-24-0651-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned future-labeled KST artifact path `2026-07-24-0651` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: 없음. `get_account_activities(activity_types=[FILL], after=2026-07-23T20:00:00Z)`와 `get_orders(status=all, after=2026-07-23T20:00:00Z)` 기준 same-session after-hours submitted/fills는 `0/0`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned future-labeled KST artifact path `2026-07-24-0651` core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T17:53:11.232909612-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `0/0`를 재확인했다. separate after-hours session budget은 아직 `2/2` available이지만 first blocking gate가 `fresh_quote`로 남아 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-24-0651-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-2151-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T08:52:58.738360244-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-2151-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 12:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-2131-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2131` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-2131-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T08:32:42.897016045-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-2131-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 12:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-2111-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2111` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-2111-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity `get_clock/get_account_info/get_all_positions/get_watchlists/get_orders(status=open)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_stock_snapshot(feed=overnight)`도 정상 동작해 `2026-07-23T08:13:35.946153144-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-2111-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 12:15 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-2051-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2051` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-2051-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T07:53:33.039814413-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-2051-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 11:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-2031-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2031` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-2031-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T07:33:11.82379705-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. strict universe/MCP/risk validators는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-2031-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 11:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-2011-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `2`다.
- Filled: `NOK` after-hours sell `2건`이 `client_order_id=ah-20260722-0931-sell-nok-01`, `filled_avg_price=10.95 USD`, `filled_at=2026-07-23T01:16:18.20135Z` 및 `client_order_id=ah-20260722-1211-sell-nok-01`, `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-22T20:00:00Z)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 이 `NOK` `2건`뿐이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-2011-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_latest_quote(feed=overnight)/get_stock_snapshot(feed=overnight)/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `2011` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS`는 stale 또는 spread/cap gate fail 상태였지만 first blocking gate는 `separate_after_hours_order_budget`로 유지돼 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `2011` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-2011-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 11:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1951-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1951` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1951-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 재확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 stale quote, spread, 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1951-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 10:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1931-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1931` preflight 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1931-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct Alpaca continuity도 정상 동작해 `2026-07-23T06:31:08.642315461-04:00` account `ACTIVE`, positions `31`, watchlists `0`, same-session after-hours filled `ah-20260722-0931-sell-nok-01`, `ah-20260722-1211-sell-nok-01` 두 건 유지를 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 재확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 stale quote, spread, 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1931-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 10:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1911-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1911` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1911-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing clock/account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. direct live continuity도 정상 동작해 `2026-07-23T06:13:03.203739417-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`을 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 stale quote, spread, 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1911-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1811-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing clock/account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. direct live continuity도 정상 동작해 `2026-07-23T05:12:50.20844995-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`을 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 stale quote, spread, 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1811-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 09:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1751-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1751` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1751-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing clock/account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. direct live continuity도 정상 동작해 `2026-07-23T04:52:49.048576273-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`을 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 stale quote, spread, 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1751-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 08:52 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1731-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1731` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1731-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing clock/account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. direct live continuity도 정상 동작해 `2026-07-23T04:33:07.438154842-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`을 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 stale quote, spread, 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1731-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 08:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1711-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1711` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1711-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing clock/account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. direct live continuity도 정상 동작해 `2026-07-23T04:13:08.261719102-04:00` regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`을 재확인했다. live overnight diagnostic에서는 `NOK 10.53/10.64`, `SO 93.29/96.54`, `WMT 108.06/122.05`, `MCD 251.87/265.36`, `QQQ 700.70/706.24`, `SPY 743.92/749.69`, `SMH 579.88/590.99`, `NEE 89.05/90.53`, `CVX 193.03/194.97`, `GS 1084.46/1102.37`를 확인했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, 동시에 전 종목이 spread 또는 per-order cap fail을 남겨 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1711-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 08:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1651-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1651` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1651-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing clock/account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. direct live continuity도 정상 동작해 `2026-07-23T03:53:05.44693557-04:00` regular market closed와 open orders `0`을 재확인했다. live overnight diagnostic에서는 `NOK 10.56/10.58`, `WMT 109.16/109.39`가 executable처럼 보였지만 submit boundary는 같은 `1651` preflight asset/quote/spread rows에 고정했고, separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐다. source-of-record preflight 기준 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS`는 stale, one-sided, spread, 또는 per-order cap fail이 남아 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1651-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 07:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1631-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1631` preflight와 live Alpaca continuity 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1631-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity도 정상 동작해 `2026-07-23T03:33:15.213226042-04:00` regular market closed, account `ACTIVE`, open orders `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. live overnight diagnostic에서는 `NOK 10.65/10.68`, `WMT 109.21/109.37`, `MCD 263.13/263.81`, `SMH 581.61/582.75`처럼 일부 개선된 quote가 보였지만 submit boundary는 같은 `1631` preflight asset/quote/spread rows에 고정했고, separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐다. source-of-record preflight 기준 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS`는 stale, one-sided, spread, 또는 per-order cap fail이 남아 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1631-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 07:37 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1611-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1611` preflight 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1611-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight passing account/order/position/quote/spread rows와 recent fill rows 기준 account `ACTIVE`, open orders `0`, watchlists `0`, same-session after-hours submitted/fills `2/2`를 재확인했다. 다만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고, `1611` preflight IEX quote rows는 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` 전반에서 stale, one-sided, spread, 또는 per-order cap fail이라 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1611-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 07:11 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1551-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1551` preflight와 live Alpaca continuity 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1551-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 11.14/11.17`, `SO 94.67/95.91`, `WMT 109.31/109.68`, `MCD 262.86/264.16`, `QQQ 703.06/703.24`, `SPY 745.52/746.58`, `SMH 586.79/587.76`, `NEE 88.98/89.53`, `CVX 194.08/194.86`, `GS 1090.64/1103.96`를 재확인했다. `NOK`는 live sell trim 기준 executable이었고 `WMT`는 live buy fallback 기준 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `MCD`/`NEE`/`CVX`/`GS`는 spread fail, `SO`는 stale+spread fail, `QQQ`/`SPY`/`SMH`/`GS`는 per-order cap fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1551-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 06:58 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1531-after-hours-autopilot]]
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1531-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 다만 core preflight에는 passing row detail이 비어 있어 registered Alpaca read-only continuity로 account/order/position/quote evidence를 보강했다. direct live continuity는 정상 동작했고 `NOK 10.99/11.01`, `SO 94.67/95.91`, `WMT 109.42/109.59`, `MCD 263.30/264.30`, `QQQ 704.37/704.49`, `SPY 745.90/746.35`, `SMH 586.90/587.87`, `NEE 88.05/89.68`, `CVX 193.42/193.97`, `GS 1091.38/1105.06`를 재확인했다. `NOK`는 live sell trim 기준 executable이었고 `WMT`는 live buy fallback 기준 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `MCD`/`CVX`/`GS`는 spread fail, `SO`는 stale+spread fail, `NEE`는 spread fail, `QQQ`/`SPY`/`SMH`/`GS`는 per-order cap fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1531-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 06:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1511-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1511-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 10.89/10.91`, `SO 94.67/95.91`, `WMT 109.39/109.45`, `MCD 262.86/263.73`, `QQQ 703.88/703.98`, `SPY 745.95/746.90`, `SMH 586.60/587.58`, `NEE 88.12/89.67`, `CVX 193.18/194.93`, `GS 1090.10/1104.06`를 재확인했다. `NOK`는 live sell trim 기준 executable이었고 `WMT`는 live buy fallback 기준 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `MCD`는 spread cap fail, `SO`/`NEE`는 stale+spread fail, `CVX`/`GS`는 spread fail, `QQQ`/`SPY`/`SMH`/`GS`는 per-order cap fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1511-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 06:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1451-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1451-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 10.89/10.94`, `SO 94.64/95.97`, `WMT 109.33/109.63`, `MCD 263.41/264.23`, `QQQ 703.37/704.19`, `SPY 746.28/746.80`, `SMH 587.54/588.49`, `NEE 88.02/90.92`, `CVX 193.34/194.92`, `GS 1090.78/1104.40`를 재확인했다. `WMT`와 `MCD`는 live buy fallback으로 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `NOK`는 spread cap fail로 전환됐고 `SO`/`NEE`는 stale+spread fail, `CVX`/`GS`는 spread fail, `QQQ`/`SPY`/`SMH`/`GS`는 per-order cap fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1451-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 05:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1431-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1431` Alpaca core preflight와 live continuity 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868059Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1431-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 10.86/10.88`, `WMT 109.23/109.73`, `MCD 263.22/264.34`, `QQQ 706.33/706.44`, `SPY 747.04/747.52`, `SMH 588.32/590.01`, `NEE 88.07/90.92`, `CVX 193.43/194.79`, `GS 1090.08/1104.87`를 재확인했다. `NOK`는 live sell trim 기준 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `SO`는 stale+spread fail, `WMT/MCD/SMH/NEE/CVX/GS`는 spread 또는 freshness gate, `QQQ/SPY/SMH/GS`는 per-order cap에 막혔다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1431-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1351-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 11.07/11.09`, `WMT 109.41/109.60`, `MCD 263.85/264.48`, `SO 94.64/95.97`를 재확인했다. `NOK` sell trim과 `WMT`/`MCD` 1주 buy fallback은 live quote 기준 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `SO`는 stale+spread fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1351-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 04:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1331-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868059Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1331-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `WMT 109.33/109.60`, `MCD 263.76/264.30`, `NOK 11.00/11.04`, `SO 94.64/95.97`를 재확인했다. `WMT`와 `MCD`는 live buy fallback으로 executable이었지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. sell-first `NOK`와 `SO`는 spread cap fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1331-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 04:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1311-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868059Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1311-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 10.98/11.00`, `MCD 263.87/264.26`, `WMT 109.33/109.69`를 재확인했다. `NOK` sell trim과 `MCD` 1주 buy fallback은 quote/spread 기준으로는 실행 가능했지만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다. `SO`는 stale+spread fail, `WMT`는 spread cap fail로 남았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1311-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 04:16 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1251-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868059Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1251-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `WMT 109.53/109.71`, `MCD 263.69/264.28`, `NOK 11.00/11.04`를 재확인했다. 다만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 유지됐고 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1251-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 03:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1231-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 유지된다. `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`, `ah-20260722-1211-sell-nok-01`은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868059Z`다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1231-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 10.92/10.93`, `MCD 264.03/264.63`, `WMT 109.47/109.70`를 재확인했다. 다만 separate after-hours session budget이 이미 `2/2`로 소진돼 first blocking gate가 `separate_after_hours_order_budget`로 고정됐고 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1231-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 03:32 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1211-after-hours-autopilot]]
- Open/new: 없음. immediate reconciliation 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `2건`이 same US-date bucket에 기록됐다. earlier `ah-20260722-0931-sell-nok-01`은 `filled_avg_price=10.95 USD`로 유지됐고, 이번 cycle `ah-20260722-1211-sell-nok-01` (`order_id=d249fed3-33a1-4b84-b84d-4902851737c9`)은 `filled_avg_price=10.78 USD`, `filled_at=2026-07-23T03:18:44.891868059Z`로 즉시 체결됐다. same-session after-hours submitted/fills는 `2/2`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=399`, `NOK qty_available=399`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1211-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. direct live continuity는 정상 동작했고 `NOK 10.78/10.80`와 `WMT 109.40/109.67`를 확인했다. sell-first 정책에 따라 `NOK` 1주 trim만 제출했고 alternate `client_order_id` retry는 없었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1211-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 03:19 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1151-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1151` preflight 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-0931-sell-nok-01`, `order_id=87eea18c-86c7-47b6-8565-4e5b56fef08b`, `filled_avg_price=10.95 USD`, `filled_at=2026-07-23T01:16:18.20135Z`로 유지됐다. same-session after-hours submitted/fills는 `1/1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: scheduler-owned `1151` preflight 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=400`, `NOK qty_available=400`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1151-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 같은 preflight recent-activity rows에서 earlier `NOK` trim fill이 유지되며 open-order lifecycle blocker가 없음을 재확인했다. 다만 submit boundary를 같은 `1151` preflight asset/quote/spread rows에 고정했을 때 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` shortlist가 모두 stale 또는 one-sided 또는 spread/per-order-cap fail이라 신규 `place_stock_order`는 호출하지 않았다. direct live continuity는 이 세션에서 Alpaca MCP wrapper DNS error로 실패해 diagnostic-only로 기록했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1151-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 02:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1131-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1131` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-0931-sell-nok-01`, `order_id=87eea18c-86c7-47b6-8565-4e5b56fef08b`, `filled_avg_price=10.95 USD`, `filled_at=2026-07-23T01:16:18.20135Z`로 유지됐다. same-session after-hours submitted/fills는 `1/1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=400`, `NOK qty_available=400`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1131-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live continuity는 `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_snapshot(feed=overnight)`로 닫았고, earlier `NOK` trim fill이 유지되며 open-order lifecycle blocker가 없음을 재확인했다. 다만 submit boundary를 같은 `1131` preflight asset/quote/spread rows에 고정했을 때 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` shortlist가 모두 stale 또는 one-sided 또는 spread/per-order-cap fail이라 신규 `place_stock_order`는 호출하지 않았다. live overnight continuity에서는 `WMT 109.39/109.56`가 진단상 pass였지만 submit boundary 밖이라 diagnostic-only로 남겼다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1131-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 02:35 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1111-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1111` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-0931-sell-nok-01`, `order_id=87eea18c-86c7-47b6-8565-4e5b56fef08b`, `filled_avg_price=10.95 USD`, `filled_at=2026-07-23T01:16:18.20135Z`로 유지됐다. same-session after-hours submitted/fills는 `1/1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=400`, `NOK qty_available=400`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1111-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live continuity는 `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_snapshot(feed=overnight)`로 닫았고, earlier `NOK` trim fill이 유지되며 open-order lifecycle blocker가 없음을 재확인했다. 다만 submit boundary를 같은 `1111` preflight asset/quote/spread rows에 고정했을 때 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` shortlist가 모두 stale 또는 one-sided 또는 spread/per-order-cap fail이라 신규 `place_stock_order`는 호출하지 않았다. live overnight continuity도 진단용으로만 확인했지만 fully executable candidate는 만들지 못했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1111-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 02:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1051-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1051` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-0931-sell-nok-01`, `order_id=87eea18c-86c7-47b6-8565-4e5b56fef08b`, `filled_avg_price=10.95 USD`, `filled_at=2026-07-23T01:16:18.20135Z`로 유지됐다. same-session after-hours submitted/fills는 `1/1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=400`, `NOK qty_available=400`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1051-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live continuity는 `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists`로 닫았고, earlier `NOK` trim fill이 유지되며 open-order lifecycle blocker가 없음을 재확인했다. 다만 submit boundary를 같은 `1051` preflight asset/quote/spread rows에 고정했을 때 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` shortlist가 모두 stale 또는 one-sided 또는 spread/per-order-cap fail이라 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1051-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 01:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-1031-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1031` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
- Filled: `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-0931-sell-nok-01`, `order_id=87eea18c-86c7-47b6-8565-4e5b56fef08b`, `filled_avg_price=10.95 USD`, `filled_at=2026-07-23T01:16:18.201349781Z`로 닫혔다. same-session after-hours submitted/fills는 `1/1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=400`, `NOK qty_available=400`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-1031-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live continuity는 `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_order_by_client_id/get_watchlists`로 닫았고, earlier `NOK` trim fill이 prior open-order lifecycle blocker를 해소했음을 재확인했다. 다만 submit boundary를 같은 `1031` preflight asset/quote/spread rows에 고정했을 때 `NOK/SO/WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` shortlist가 모두 stale 또는 one-sided 또는 spread/per-order-cap fail이라 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-23-1031-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 01:34 UTC_
...
- Filled: 없음. same `client_order_id` reconciliation 기준 `filled_qty=0`, `filled_avg_price=null`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: `0951` source-of-record preflight와 live continuity 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`, `NOK qty_available=400`이다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0951-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. live continuity에서 `NOK` overnight quote `10.89/10.91`와 existing open order continuity를 재확인했지만 same symbol/side duplicate-open-order gate 때문에 신규 `place_stock_order`는 호출하지 않았다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0951-after-hours-autopilot-post-trade.json`
...
- Recent reconciliation scope: scheduler-owned `2026-07-23-0911-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T20:11:11.898543748-04:00`를 사용했고, 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists` readback으로 continuity를 닫았다. submit boundary는 같은 `0911` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0911-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-23 00:12 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0851-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0851-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T19:51:10.452762753-04:00`를 사용했고, 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists` readback으로 continuity를 닫았다. submit boundary는 같은 `0851` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0851-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 23:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0831-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0831-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T19:31:09.214969104-04:00`를 사용했고, 이어서 live Alpaca MCP `get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists` readback으로 continuity를 닫았다. submit boundary는 같은 `0831` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0831-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 23:35 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0811-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0811-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T19:11:10.956045282-04:00`를 사용했고, 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `0811` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0811-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 23:15 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0751-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0751-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T18:51:09.44714194-04:00`를 사용했고, 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `0751` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0751-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 22:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0731-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0731-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T18:31:15.655816446-04:00`를 사용했고, 이어서 live Alpaca MCP `get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `0731` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0731-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 22:35 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0711-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0711-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. regular market close 판단은 같은 preflight clock row `2026-07-22T18:11:15.730441015-04:00`를 사용했고, 이어서 live Alpaca MCP `get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `0711` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0711-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0631-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `0631` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0631-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 21:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-23-0611-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `0`이다.
- Filled: 없음. live `get_orders(status=all, after=2026-07-22T20:00:00Z)` 기준 same-session after-hours fills/orders는 `0건`이었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-23-0611-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `0611` preflight asset/quote/spread rows에 고정했고, `NOK/SO` sell path와 `WMT/MCD/QQQ/SPY/SMH/NEE/CVX/GS` buy fallback path 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-23-0611-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 21:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-2151-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `2`다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 유지됐고 `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-2111-sell-nok-01`, `filled_avg_price=10.33 USD`, `filled_at=2026-07-22T12:30:02.329191394Z`로 유지됐다. live `get_orders(status=all, after=2026-07-21T20:00:00-04:00)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 `AVGO`, `NOK` 두 건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-2151-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `2151` preflight asset/quote/spread rows에 고정했고 `NOK 10.29/10.31` fresh row가 남아 있었지만 same-session after-hours budget이 이미 `2/2`로 소진돼 first blocking gate는 `separate_after_hours_order_budget`이었다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 2.
- Source note: `wiki/trade-ledger/positions/2026-07-22-2151-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 12:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-2131-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `2`다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 유지됐고 `NOK` after-hours sell `1건`이 `client_order_id=ah-20260722-2111-sell-nok-01`, `filled_avg_price=10.33 USD`, `filled_at=2026-07-22T12:30:02.329191Z`로 새로 체결 완료됐다. live `get_orders(status=all, after=2026-07-21T20:00:00-04:00)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 `AVGO`, `NOK` 두 건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=401`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-2131-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `2131` preflight asset/quote/spread rows에 고정했고 `NOK 10.32/10.33`, `SPY 745.62/745.74` fresh row가 남아 있었지만 same-session after-hours budget이 이미 `2/2`로 소진돼 first blocking gate는 `separate_after_hours_order_budget`이었다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 2.
- Source note: `wiki/trade-ledger/positions/2026-07-22-2131-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 12:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-2051-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_orders(status=all, after=2026-07-22T00:00:00Z)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 `AVGO` `1건`뿐이다.
- Cancelled: 없음
...
- Recent reconciliation scope: scheduler-owned `2026-07-22-2051-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `2051` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `2051` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-2051-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 11:52 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-2031-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_orders(status=all, after=2026-07-21T20:00:00-04:00)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 `AVGO` `1건`뿐이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-2031-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `2031` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `2031` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-2031-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 11:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-2011-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_orders(status=all, after=2026-07-21T20:00:00-04:00)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 `AVGO` `1건`뿐이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-2011-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `2011` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `2011` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-2011-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 11:15 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1951-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. direct `get_order_by_client_id` 기준 same-session fills/orders continuity는 이 `AVGO` `1건`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1951-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1951` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1951` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1951-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 10:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1931-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. direct `get_order_by_client_id` 기준 same-session fills/orders continuity는 이 `AVGO` `1건`으로 유지됐다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1931-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1931` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1931` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1931-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 10:35 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1911-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_orders(status=all, after=2026-07-21T20:00:00-04:00)`와 direct `get_order_by_client_id` 기준 same-session fills/orders는 `AVGO` `1건`뿐이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1911-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1911` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1911` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1911-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 10:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1851-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1851-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1851` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1851` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1851-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 09:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1831-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1831-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1831` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1831` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1831-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 09:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1811-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1811-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1811` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1811` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1811-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 09:17 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1751-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1751-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1751` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1751` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1751-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 08:52 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1731-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1731-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1731` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1731` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1731-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 08:32 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1711-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1711-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1711` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1711` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1711-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 08:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1651-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1651-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1651` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1651` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1651-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 07:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1631-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1631-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1631` preflight asset/quote/spread rows로 고정했고, `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 stale 또는 one-sided 또는 spread/cap/review gate fail이라 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1631` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1631-after-hours-autopilot-post-trade.json`
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1551-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1551` preflight asset/quote/spread rows로 고정했고, 그 source-of-record quote들이 stale 또는 one-sided여서 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 after-hours quote 또는 spread 또는 cap gate를 통과하지 못했다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1551` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1551-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 06:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1531-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933755903Z`로 계속 체결 완료 상태다. same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1531-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_watchlists/get_order_by_client_id`로 continuity를 닫았다. submit boundary는 같은 `1531` preflight asset/quote/spread rows로 고정했고, 그 source-of-record quote들이 stale 또는 one-sided여서 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 after-hours quote 또는 spread 또는 cap gate를 통과하지 못했다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1531` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1531-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 06:33 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1511-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1511` preflight와 same client id readback 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933755903Z`로 계속 체결 완료 상태다. same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1511-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. submit boundary는 같은 `1511` preflight asset/quote/spread rows로 고정했고, 그 source-of-record quote들이 stale 또는 one-sided여서 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 after-hours quote 또는 spread 또는 cap gate를 통과하지 못했다. runtime overnight quote/snapshot spot-check는 continuity 참고로만 기록했고 submit path는 다시 열지 않았다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1511-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 06:11 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1451-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933755903Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1451-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `1451` preflight의 asset/quote/spread rows로 고정했고, 그 source-of-record quote들이 stale 또는 one-sided여서 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 after-hours quote 또는 spread 또는 cap gate를 통과하지 못했다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1451` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1451-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 05:51 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1431-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933755903Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1431-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_watchlists`로 continuity를 닫았다. submit boundary는 같은 `1431` preflight의 asset/quote/spread rows로 고정했고, 그 source-of-record quote들이 stale 또는 one-sided여서 `SO/WMT/MCD/QQQ/SPY/SMH/NOK/NEE/CVX/GS` 모두 after-hours quote 또는 spread 또는 cap gate를 통과하지 못했다. 따라서 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1431` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1431-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 05:36 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1411-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `get_orders(status=open)` source-of-record 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00-04:00)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1411-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_account_info/get_all_positions/get_watchlists/get_account_activities(activity_types=[FILL])/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 fresh지만 spread fail, `WMT`는 spread+backlog fail, `MCD`는 quote/spread/notional pass였지만 backlog throttle fail, `QQQ/SPY`는 per-order cap, `SMH`는 spread+cap fail, `NOK`는 spread+review gate fail, `NEE/CVX/GS`는 spread+freshness fail 때문에 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1411` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1411-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 05:13 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1351-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_orders(status=all, after=2026-07-21T20:00:00-04:00)` 기준 same-session fills/orders는 `AVGO` `1건`뿐이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1351-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_order_by_client_id/get_watchlists/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT`는 spread+backlog fail, `MCD`는 quote/spread/notional pass였지만 backlog throttle fail, `QQQ/SPY`는 per-order cap, `SMH/NOK/NEE/CVX/GS`는 spread 또는 freshness 또는 review gate fail 때문에 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1351` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1351-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 04:55 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1331-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1331-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT/MCD/SMH/CVX/NEE/GS`는 spread 또는 freshness fail, `QQQ/SPY`는 per-order cap, `NOK`는 review add-block+backlog throttle에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1331` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1331-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 04:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1311-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1311-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `WMT`는 fresh under-cap fallback이었지만 `review_backlog_pending_1d_count=17` backlog throttle에 막혔고 `SO`는 stale+spread fail, `MCD/SMH/NOK/NEE/CVX/GS`는 spread 또는 freshness fail, `QQQ/SPY`는 per-order cap에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1311` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1311-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 04:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1251-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1251-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT`는 backlog throttle, `MCD/SMH/NOK/NEE/GS`는 spread fail, `QQQ/SPY`는 per-order cap, `CVX`는 freshness fail에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1251` strict universe/MCP/risk gate는 모두 PASS였고 risk validator warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1251-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 03:54 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1231-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1231-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT`는 spread+backlog fail, `MCD`는 backlog throttle, `QQQ/SPY/SMH`는 per-order cap, `NOK`는 review add-block, `NEE/GS`는 spread fail, `CVX`는 freshness fail에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1231` risk validator는 `PyYAML` dependency 누락으로 FAIL했고 strict universe/MCP gate는 PASS였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1231-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 03:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1211-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1211-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT/MCD`는 review backlog throttle, `QQQ/SPY/SMH`는 per-order cap, `NOK`는 spread+review add-block, `NEE/CVX/GS`는 spread 또는 freshness fail에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1211` risk validator는 PASS였고 warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1211-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 03:14 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1151-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1151-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_stock_latest_quote(feed=overnight|iex)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT/MCD`는 review backlog throttle, `QQQ/SPY/SMH`는 per-order cap, `NOK`는 spread+review add-block, `NEE/CVX/GS`는 spread 또는 freshness fail에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1151` risk validator는 PASS였고 warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1151-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 02:53 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1131-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: scheduler-owned `1131` core preflight `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1131-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT/MCD`는 spread+backlog fail, `QQQ/SPY/SMH`는 per-order cap, `NOK`는 review add-block, `NEE/CVX/GS`는 spread fail에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1131` risk validator는 PASS였고 warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1131-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 02:34 UTC_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-07-22-1111-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933756Z`로 계속 체결 완료 상태다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1111-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_stock_latest_quote(feed=overnight|iex)`로 continuity를 닫았다. `AVGO` sell은 same client id 기준 `status=filled`를 유지했고 `open_orders=0`가 유지됐다. 이후 `SO`는 stale+spread fail, `WMT`는 spread+backlog fail, `MCD`는 backlog throttle, `QQQ/SPY`는 per-order cap, `SMH/NOK/NEE/CVX/GS`는 spread 또는 freshness gate에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1111` risk validator는 PASS였고 warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1111-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 02:14 UTC_

- Run: [[2026-07-22-1051-after-hours-autopilot]]
- Open/new: 없음. live `get_orders(status=open)` 기준 open orders `0`, same-session after-hours submitted orders `1`이다.
- Filled: `AVGO` after-hours sell `1건`이 `client_order_id=ah-20260722-0911-sell-avgo-01`, `filled_avg_price=384.14 USD`, `filled_at=2026-07-22T01:48:58.933755903Z`로 체결 완료됐다. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `1`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `31`건이며 `AVGO position 없음`, `SO qty=6`, `QQQ qty=3`, `SPY qty=2`, `WMT qty=10`, `NOK qty=402`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1051-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_order_by_client_id/get_order_by_id/get_account_activities(activity_types=[FILL])/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` sell은 same client id readback 기준 `status=filled`로 닫혔고 `open_orders=0`가 됐다. 이후 `SO`는 stale+spread fail, `WMT/MCD`는 `review_backlog_pending_1d_count=17` throttle, `QQQ/SPY/SMH`는 per-order cap, `NOK/NEE/CVX/GS`는 spread 또는 add-block gate에 막혀 신규 `place_stock_order` 없이 reconcile-only로 종료했다. `1051` risk validator는 PASS였고 warning은 `orders is empty`뿐이었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1051-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 01:55 UTC_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `32`건이며 `RGTI position 없음`, `SO qty=6`, `AVGO qty=1`, `AVGO qty_available=0`, `QQQ qty=3`, `SPY qty=2`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-1011-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` overnight quote `383.21/384.59`, spread 약 `0.3595%`, quote age 약 `0.03`분으로 여전히 fresh했지만 같은 `client_order_id=ah-20260722-0911-sell-avgo-01` 주문이 `status=new`로 유지돼 no-retry lifecycle record만 남겼다. `1011` risk validator는 이 open order age `51.8분`이 lifecycle limit `30.0분`을 초과해 FAIL했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-22-1011-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 01:12 UTC_

- Run: [[2026-07-22-0951-after-hours-autopilot]]
- Open/new: `AVGO` after-hours sell `1`건이 계속 open 상태다. live `get_orders(status=open)`와 `get_orders(status=all, after=2026-07-21T20:00:00Z)` 기준 open orders `1`, same-session after-hours submitted orders `1`이다.
- Filled: 없음. live `get_account_activities(activity_types=[FILL], after=2026-07-21T20:00:00Z)` 기준 same-session fills `0`이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `32`건이며 `RGTI position 없음`, `SO qty=6`, `AVGO qty=1`, `AVGO qty_available=0`, `QQQ qty=3`, `SPY qty=2`다.
- Recent reconciliation scope: scheduler-owned `2026-07-22-0951-*` Alpaca core/research preflight를 source-of-record로 사용했고 Alpaca core `first_blocking_gate=market_closed`는 after-hours expected nonblocking으로 처리했다. 이어서 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_account_activities(activity_types=[FILL])/get_order_by_client_id/get_stock_latest_quote(feed=overnight)`로 continuity를 닫았다. `AVGO` overnight quote `383.51/384.51`, spread 약 `0.2604%`, quote age 약 `0.15`분으로 여전히 fresh했지만 같은 `client_order_id=ah-20260722-0911-sell-avgo-01` 주문이 `status=new`로 유지돼 no-retry lifecycle record만 남겼다. `0951` risk validator는 이 open order age `32.6분`이 lifecycle limit `30.0분`을 초과해 FAIL했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-07-22-0951-after-hours-autopilot-post-trade.json`

_Last updated: 2026-07-22 00:53 UTC_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `32`건이며 `RGTI position 없음`이다.
- Recent reconciliation scope: scheduler-owned `0431` stale cleanup/core/research preflight를 source-of-record로 사용했고 Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_stock_latest_quote/get_asset/place_stock_order/get_order_by_client_id`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,610.97 USD`, portfolio value `101,711.72 USD`, buying power `303,829.08 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 1.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0431-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 04:39 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0411-hourly-autopilot]]
- Open/new: 없음. `hourly-20260619-0411-sell-rgti` 1주 sell은 same client id readback 기준 즉시 `filled`다.
- Filled: `hourly-20260619-0411-sell-rgti` 1주 sell이 `2026-06-18T19:16:44.852563Z`에 `filled_avg_price=20.8 USD`로 체결됐다. same-day filled reference는 `hourly-20260619-0351-sell-rgti` 1주 `20.78 USD`, `0331` 1주 `20.70 USD`, `0311` 1주 `20.61 USD`, `0231` 1주 `20.68 USD`, `0211` 1주 `20.72 USD`, `0151` 2주 `20.50 USD`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=1`, `qty_available=1`다.
- Recent reconciliation scope: scheduler-owned `0411` stale cleanup/core/research preflight를 source-of-record로 사용했고 Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/place_stock_order/get_order_by_client_id`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,590.10 USD`, portfolio value `101,563.37 USD`, buying power `303,557.49 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0411-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 04:17 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0351-hourly-autopilot]]
- Open/new: 없음. `hourly-20260619-0351-sell-rgti` 1주 sell은 same client id readback 기준 즉시 `filled`다.
- Filled: `hourly-20260619-0351-sell-rgti` 1주 sell이 `2026-06-18T18:54:19.386630Z`에 `filled_avg_price=20.78 USD`로 체결됐다. same-day filled reference는 `hourly-20260619-0331-sell-rgti` 1주 `20.70 USD`, `0311` 1주 `20.61 USD`, `0231` 1주 `20.68 USD`, `0211` 1주 `20.72 USD`, `0151` 2주 `20.50 USD`, `0111` 3주 `20.43 USD`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=2`, `qty_available=2`다.
- Recent reconciliation scope: scheduler-owned `0351` stale cleanup/core/research preflight를 source-of-record로 사용했고 Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/place_stock_order/get_order_by_client_id`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,569.30 USD`, portfolio value `101,574.37 USD`, buying power `303,606.78 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0351-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 03:54 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0331-hourly-autopilot]]
- Open/new: 없음. `hourly-20260619-0331-sell-rgti` 1주 sell은 same client id readback 기준 즉시 `filled`다.
- Filled: `hourly-20260619-0331-sell-rgti` 1주 sell이 `2026-06-18T18:37:39.173809Z`에 `filled_avg_price=20.7 USD`로 체결됐다. same-day filled reference는 `hourly-20260619-0311-sell-rgti` 1주 `20.61 USD`, `0231` 1주 `20.68 USD`, `0211` 1주 `20.72 USD`, `0151` 2주 `20.50 USD`, `0111` 3주 `20.43 USD`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=3`, `qty_available=3`다.
- Recent reconciliation scope: scheduler-owned `0331` stale cleanup/core/research preflight를 source-of-record로 사용했고 Alpaca MCP `place_stock_order/get_order_by_client_id/get_orders(status=open|all)/get_all_positions/get_account_info/get_watchlists/get_account_activities(FILL)`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,548.52 USD`, portfolio value `101,487.20 USD`, buying power `303,435.01 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0331-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 03:38 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0311-hourly-autopilot]]
- Open/new: `hourly-20260619-0311-sell-rgti` 1주 sell이 immediate reconciliation 기준 `status=new` open order로 남아 있다.
- Filled: 이번 cycle 신규 fill은 아직 없다. same-day filled reference는 `hourly-20260619-0231-sell-rgti` 1주 `20.68 USD`, `hourly-20260619-0211-sell-rgti` 1주 `20.72 USD`, `hourly-20260619-0151-sell-rgti` 2주 `20.50 USD`, `hourly-20260619-0111-sell-rgti` 3주 `20.43 USD`, `hourly-20260619-0011-sell-rgti` 3주 `20.68 USD`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=5`, `qty_available=4`다.
- Recent reconciliation scope: scheduler-owned `0311` stale cleanup/core/research preflight를 source-of-record로 사용했고 Alpaca MCP `place_stock_order/get_order_by_client_id/get_orders(status=open|all)/get_all_positions/get_account_info/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,507.21 USD`, portfolio value `101,479.98 USD`, buying power `303,365.22 USD`, open orders `1`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0311-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 03:17 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0251-hourly-autopilot]]
- Open/new: 없음. scheduler-owned `0251` stale cleanup/core preflight와 same-day fill ledger 기준 open orders `0`이다.
- Filled: 직전 `hourly-20260619-0231-sell-rgti` 1주 sell이 scheduler `get_account_activities(activity_types=[FILL])` 기준 `2026-06-18T17:40:01.953993Z`에 `filled_avg_price=20.68 USD`로 체결 완료다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이며 `RGTI qty=5`, `qty_available=5`다.
- Recent reconciliation scope: scheduler-owned `0251` stale cleanup/core/research preflight를 source-of-record로 사용했다. source-of-record 기준 account `ACTIVE`, cash `28,507.21 USD`, portfolio value `101,661.12 USD`, buying power `303,804.87 USD`, open orders `0`, watchlists `0`였고 research strict gate는 `SEC EDGAR`, `FRED` 2-provider pass만 남아 submit gate가 닫혔다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0251-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 02:54 KST_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=6`, `qty_available=6`이다.
- Recent reconciliation scope: scheduler-owned `0211` stale cleanup/core/research preflight를 source-of-record로 사용했고 Alpaca MCP `place_stock_order/get_order_by_id/get_orders(status=open|all)/get_all_positions/get_account_info/get_watchlists`로 submit-boundary와 follow-up post-trade state를 재확인했다. readback 기준 account `ACTIVE`, cash `28,486.53 USD`, portfolio value `101,704.09 USD`, buying power `303,894.75 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0211-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 02:20 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0151-hourly-autopilot]]
- Open/new: 없음. follow-up reconciliation 기준 open orders `0`이다.
- Filled: `hourly-20260619-0151-sell-rgti` 2주 sell이 `2026-06-18T16:57:27.477402Z`에 `filled_avg_price=20.50 USD`로 전량 체결됐다. same-day filled reference는 earlier `hourly-20260619-0111-sell-rgti` 3주 sell `filled_avg_price=20.43 USD`, `hourly-20260619-0011-sell-rgti` 3주 sell `filled_avg_price=20.68 USD`다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=7`, `qty_available=7`이다.
- Recent reconciliation scope: scheduler-owned `0151` stale cleanup/core/research preflight를 source-of-record로 사용했고 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open|all)/get_watchlists/get_stock_snapshot/get_asset/get_order_by_client_id`로 submit-boundary와 follow-up post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,465.81 USD`, portfolio value `101,516.55 USD`, buying power `303,304.37 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0151-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 01:57 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0131-hourly-autopilot]]
- Open/new: 없음. scheduler-owned `0131` stale cleanup/core preflight와 same-day fill ledger 기준 open orders `0`이다.
- Filled: `0111` cycle `hourly-20260619-0111-sell-rgti` 3주 sell이 scheduler `get_account_activities(activity_types=[FILL])` 기준 `filled_avg_price=20.43 USD`, `transaction_time=2026-06-18T16:21:48.495146Z`로 체결 완료다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이며 `RGTI qty=9`, `qty_available=9`다.
- Recent reconciliation scope: scheduler-owned `0131` stale cleanup/core/research preflight를 source-of-record로 사용했다. source-of-record 기준 account `ACTIVE`, cash `28,424.81 USD`, portfolio value `101,595.45 USD`, buying power `303,308.26 USD`, open orders `0`, watchlists `0`였고 research strict gate는 `SEC EDGAR`, `FRED` 2-provider pass만 남아 submit gate가 닫혔다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0131-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 01:31 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0111-hourly-autopilot]]
- Open/new: `hourly-20260619-0111-sell-rgti` 3주 sell이 immediate reconciliation 기준 `status=new` open order로 남아 있다.
- Filled: 없음. 이번 cycle 신규 fill은 아직 없다.
- Cancelled: 직전 `hourly-20260619-0031-sell-rgti`는 live reconciliation 기준 `2026-06-18T16:11:08.810076002Z`에 `status=canceled`로 정리됐다.
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=12`, `qty_available=9`다.
- Recent reconciliation scope: scheduler-owned `0111` stale cleanup/core/research preflight를 source-of-record로 사용했고 live Alpaca MCP `get_order_by_client_id/get_orders(status=open|all)/get_account_info/get_all_positions/get_watchlists/get_account_activities(FILL)`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,363.52 USD`, portfolio value `101,523.92 USD`, buying power `303,056.93 USD`, open orders `1`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0111-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 01:20 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0051-hourly-autopilot]]
- Open/new: 기존 `hourly-20260619-0031-sell-rgti` 3주 sell이 live reconciliation 기준 여전히 `status=new` open order다.
- Filled: 없음. 이번 cycle 신규 fill은 아직 없다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=12`, `qty_available=9`다.
- Recent reconciliation scope: scheduler-owned `0051` stale cleanup/core/research preflight를 source-of-record로 사용했고 live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_order_by_client_id/get_watchlists/get_stock_latest_quote/get_asset`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,363.52 USD`, portfolio value `101,526.24 USD`, buying power `303,023.93 USD`, open orders `1`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0051-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 00:53 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0031-hourly-autopilot]]
- Open/new: `hourly-20260619-0031-sell-rgti` 3주 sell이 immediate reconciliation 기준 `status=new` open order로 남아 있다.
- Filled: 없음. 이번 cycle 신규 fill은 아직 없다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=12`, `qty_available=9`다.
- Recent reconciliation scope: scheduler-owned `0031` stale cleanup/core/research preflight를 source-of-record로 사용했고 live Alpaca MCP `place_stock_order/get_order_by_client_id/get_orders(status=open|all)/get_all_positions/get_account_info/get_watchlists/get_clock`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,363.52 USD`, portfolio value `101,364.57 USD`, buying power `302,650.16 USD`, open orders `1`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0031-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 00:35 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-19-0011-hourly-autopilot]]
- Open/new: `hourly-20260619-0011-sell-rgti` 3주 sell이 immediate reconciliation 기준 `status=new` open order로 남아 있다.
- Filled: 없음. 이번 cycle 신규 fill은 아직 없다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=15`, `qty_available=12`다.
- Recent reconciliation scope: scheduler-owned `0011` stale cleanup/core/research preflight를 source-of-record로 사용했고 live Alpaca MCP `get_clock/get_account_info/get_orders(status=open|all)/get_all_positions/get_stock_latest_quote/get_watchlists/place_stock_order/get_order_by_client_id`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,301.48 USD`, portfolio value `101,530.37 USD`, buying power `302,809.21 USD`, open orders `1`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-19-0011-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 00:19 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-18-2351-hourly-autopilot]]
- Open/new: 없음. `hourly-20260618-2351-sell-rgti` 5주 sell은 same client id reconciliation 기준 즉시 `filled`다.
- Filled: `RGTI` sell 5주 `20.812 USD`, `filled_at=2026-06-18T15:00:14.548344756Z`.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이며 `RGTI qty=15`로 감소했다.
- Recent reconciliation scope: scheduler-owned `2351` stale cleanup/core/research preflight를 source-of-record로 사용했고 live Alpaca MCP `place_stock_order/get_order_by_client_id/get_orders(status=open|all)/get_all_positions/get_account_info/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,301.48 USD`, portfolio value `101,683.39 USD`, buying power `303,198.26 USD`, open orders `0`, watchlists `0`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-2351-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-19 00:00 KST_
...
- Recent reconciliation scope: scheduler-owned `0351` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_order_by_client_id/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_info/get_all_positions/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,003.45 USD`, portfolio value `101,151.93 USD`, buying power `300,997.97 USD`, open orders `0`, watchlists `0`, `NVDA qty=39`, `avg_entry_price=214.805897`, `current_price=206.2`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0351-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 04:01 KST_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `0231` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_clock/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_all_positions/get_account_info/get_account_activities(activity_types=[FILL])/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,324.87 USD`, portfolio value `101,389.38 USD`, buying power `302,037.29 USD`, open orders `0`, `SLB qty=8`, `avg_entry_price=55.0625`, `current_price=51.315`, `SO qty=6`, `PLTR qty=3`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0231-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 02:39 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-18-0211-hourly-autopilot]]
- Open/new: 없음. `hourly-20260618-0211-buy-so` 1주 buy는 immediate reconciliation 기준 이미 `filled`다.
- Filled: same US-date fill ledger에는 신규 `SO` buy 1주 `93.24 USD`, `COP` buy 1주 `110.83 USD`, `GOOGL` buy 1주 `365.24 USD`, `AAPL` buy 1주 `298.42 USD`, `XOM` buy 1주 `141.54 USD`, `MSFT` buy 1주 `385.40 USD`, `AMZN` buy 1주 `240.44 USD`, `NEE` buy 1주 `86.38 USD`, `NKE` buy 1주 `45.30 USD`, `FCX` buy 1주 `71.40 USD`, `WMT` buy 1주 `119.83 USD`, `BAC` buy 1주 `57.57 USD`, prior after-hours `PFE` sell 1주 `26.03 USD`, `RGTI` sell 1주 `20.96 USD`가 남아 있었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `0211` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_clock/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_all_positions/get_account_info/get_account_activities(activity_types=[FILL])/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,376.19 USD`, portfolio value `101,309.29 USD`, buying power `301,908.39 USD`, open orders `0`, `SO qty=6`, `avg_entry_price=92.801667`, `current_price=93.23`, `COP qty=7`, `PLTR qty=3`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0211-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 02:19 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-18-0151-hourly-autopilot]]
- Open/new: 없음. `hourly-20260618-0151-buy-cop` 1주 buy는 immediate reconciliation 기준 이미 `filled`다.
- Filled: same US-date fill ledger에는 신규 `COP` buy 1주 `110.83 USD`, `GOOGL` buy 1주 `365.24 USD`, `AAPL` buy 1주 `298.42 USD`, `XOM` buy 1주 `141.54 USD`, `MSFT` buy 1주 `385.40 USD`, `AMZN` buy 1주 `240.44 USD`, `NEE` buy 1주 `86.38 USD`, `NKE` buy 1주 `45.30 USD`, `FCX` buy 1주 `71.40 USD`, `WMT` buy 1주 `119.83 USD`, `BAC` buy 1주 `57.57 USD`, prior after-hours `PFE` sell 1주 `26.03 USD`, `RGTI` sell 1주 `20.96 USD`가 남아 있었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `0151` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_clock/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_all_positions/get_account_info/get_account_activities(activity_types=[FILL])/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `28,469.43 USD`, portfolio value `101,300.94 USD`, buying power `302,008.15 USD`, open orders `0`, `COP qty=7`, `avg_entry_price=116.012857`, `current_price=110.81`, `GOOGL qty=5`, `AAPL qty=7`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0151-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 02:00 KST_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `0111` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_clock/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_all_positions/get_account_info`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `29,243.92 USD`, portfolio value `101,357.51 USD`, buying power `302,842.52 USD`, open orders `1`, `AAPL qty=6`, `avg_entry_price=301.965`, `current_price=298.56`, `XOM qty=7`, `avg_entry_price=147.394286`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0111-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 01:19 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-18-0051-hourly-autopilot]]
- Open/new: `hourly-20260618-0051-buy-xom` 1주 buy가 immediate reconciliation 기준 `status=new` open order로 남아 있다.
- Filled: same US-date fill ledger에는 earlier `MSFT` buy 1주 `385.40 USD`, `AMZN` buy 1주 `240.44 USD`, `NEE` buy 1주 `86.38 USD`, `NKE` buy 1주 `45.30 USD`, `FCX` buy 1주 `71.40 USD`, `WMT` buy 1주 `119.83 USD`, `BAC` buy 1주 `57.57 USD`, prior after-hours `PFE` sell 1주 `26.03 USD`, `RGTI` sell 1주 `20.96 USD`가 남아 있었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `0051` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_clock/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_all_positions/get_account_info/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `29,385.46 USD`, portfolio value `101,434.09 USD`, buying power `303,349.92 USD`, open orders `1`, watchlists `0`, `XOM qty=6`, `avg_entry_price=148.37`, `current_price=141.6101`, `MSFT qty=5`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0051-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 00:59 KST_

## 최신 hourly-autopilot reconciliation

- Run: [[2026-06-18-0031-hourly-autopilot]]
- Open/new: 없음. `hourly-20260618-0031-buy-msft` 1주 buy는 immediate reconciliation 기준 이미 `filled`다.
- Filled: same US-date fill ledger에는 신규 `MSFT` buy 1주 `385.40 USD`, `AMZN` buy 1주 `240.44 USD`, `NEE` buy 1주 `86.38 USD`, `NKE` buy 1주 `45.30 USD`, `FCX` buy 1주 `71.40 USD`, `WMT` buy 1주 `119.83 USD`, `BAC` buy 1주 `57.57 USD`, prior after-hours `PFE` sell 1주 `26.03 USD`, `RGTI` sell 1주 `20.96 USD`가 남아 있었다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: direct `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `0031` core/research preflight를 source-of-record로 사용했고, live Alpaca MCP `get_clock/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_all_positions/get_account_info/get_watchlists`로 submit-boundary와 post-trade state를 재확인했다. live readback 기준 account `ACTIVE`, cash `29,385.46 USD`, portfolio value `101,355.71 USD`, buying power `303,339.54 USD`, open orders `0`, watchlists `0`, `MSFT qty=5`, `avg_entry_price=401.028`, `current_price=385.38`, `AMZN qty=8`였다.
- Orders submitted/replaced/cancelled/closed by this workflow: 1 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-18-0031-hourly-autopilot-post-trade.json`

_Last updated: 2026-06-18 00:38 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-2151-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2151` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. prior `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐고 scheduler-owned `get_account_activities(activity_types=[FILL])` 기준 same-session after-hours submitted orders/fills는 계속 `2/2`였다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `2151` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing clock/account/positions/open-orders/activity/watchlists/asset/quote/snapshot/trade rows였고, 별도 runtime continuity 재호출 없이 same-session budget closure와 current state를 유지했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,444.78 USD`, buying power `304,385.69 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-2151-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 21:54 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-2131-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2131` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. exact same `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. direct `get_order_by_client_id` readback 기준 same-session after-hours submitted orders/fills는 계속 `2/2`였다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `2131` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, direct Alpaca MCP `get_clock/get_all_positions/get_watchlists/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)/get_stock_snapshot(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 regular market closed, positions `33`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`, overnight quote parity를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,355.28 USD`, buying power `304,101.53 USD`였고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-2131-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 21:33 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-2111-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2111` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었다.
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `2111` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, local direct Alpaca MCP continuity는 현재 shell Python 환경의 `mcp` 모듈 부재 때문에 재실행하지 못했다. 대신 latest `2051` reconciliation chain과 same-session `client_order_id` fill ledger를 continuity 근거로 유지했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,288.40 USD`, buying power `303,958.83 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-2111-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 21:13 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-2051-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2051` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders는 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `2051` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_watchlists` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,188.22 USD`, buying power `303,767.71 USD`였고 live continuity 기준 regular market closed, positions `33`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-2051-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 20:53 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-2031-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `2031` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `2031` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_watchlists/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)/get_stock_snapshot(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,234.77 USD`, buying power `303,865.17 USD`였고 live continuity 기준 portfolio value `101,230.17 USD`, buying power `303,852.30 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-2031-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 20:33 KST_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1951` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_watchlists/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)/get_stock_snapshot(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,319.19 USD`, buying power `304,056.75 USD`였고 live continuity 기준 portfolio value `101,323.35 USD`, buying power `304,073.82 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1951-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 19:53 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1931-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1931` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1931` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_watchlists/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)/get_stock_snapshot(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,328.20 USD`, buying power `304,047.99 USD`였고 live continuity 기준 portfolio value `101,316.48 USD`, buying power `304,032.07 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1931-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 19:37 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1911-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1911` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live continuity는 exact same `client_order_id`, current account/all-position/watchlist, overnight quote parity 재확인으로 제한했다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1911` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_account_info/get_all_positions/get_watchlists/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)/get_stock_snapshot(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30391.78 USD`, portfolio value `101253.81 USD`, buying power `303884.72 USD`였고 live continuity 기준 portfolio value `101261.92 USD`, buying power `303884.92 USD`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1911-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 19:14 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1851-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1851` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1851` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_watchlists/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)/get_stock_snapshot(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,314.44 USD`, buying power `304,037.60 USD`였고 live continuity 기준 portfolio value `101,307.91 USD`, buying power `304,025.52 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1851-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 18:54 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1831-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1831` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1831` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_watchlists/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,357.95 USD`, buying power `304,221.33 USD`였고 live continuity 기준 portfolio value `101,356.34 USD`, buying power `304,205.58 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1831-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 18:34 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1811-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1811` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1811` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_account_info/get_all_positions/get_watchlists/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,350.79 USD`, buying power `304,201.29 USD`였고 live continuity 기준 portfolio value `101,349.28 USD`, buying power `304,185.80 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1811-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 18:14 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1751-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1751` preflight `get_orders_open` source-of-record 기준 open orders `0`건이었고, live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1751` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_account_info/get_all_positions/get_watchlists/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,219.71 USD`, buying power `303,991.50 USD`였고 live continuity 기준 portfolio value `101,220.43 USD`, buying power `303,993.87 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1751-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 17:54 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1731-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1731` preflight `get_orders_open` 기준 open orders `0`건이었고 이번 cycle의 live continuity는 exact same `client_order_id` reconciliation, current account/all-position/watchlist, overnight quote parity로만 제한했다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. scheduler-owned `get_account_activities(activity_types=[FILL])` row와 same `client_order_id` readback 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1731` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_account_info/get_all_positions/get_watchlists/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.78 USD`, portfolio value `101,311.23 USD`, buying power `304,259.49 USD`였고 live continuity 기준 portfolio value `101,285.13 USD`, buying power `304,197.55 USD`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1731-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 17:34 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1711-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1711` preflight `get_orders_open` 기준 open orders `0`건이었고 이번 cycle의 live continuity는 exact same `client_order_id` reconciliation, current account/all-position/watchlist, overnight quote parity로만 제한했다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. scheduler-owned `get_account_activities(activity_types=[FILL])` row와 same `client_order_id` readback 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1711` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_account_info/get_all_positions/get_watchlists/get_order_by_client_id/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.80 USD`, portfolio value `101,361.84 USD`, buying power `304,372.96 USD`였고 live continuity 기준 portfolio value `101,359.47 USD`, buying power `304,360.69 USD`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1711-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 17:13 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1651-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1651` preflight `get_orders_open` 기준 open orders `0`건이었고 live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1651` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.80 USD`, portfolio value `101,310.49 USD`, buying power `304,324.85 USD`였고 live continuity 기준 portfolio value `101,314.75 USD`, buying power `304,336.78 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1651-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 16:54 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1631-after-hours-autopilot]]
- Open/new: 없음. source-of-record `1631` preflight `get_orders_open` 기준 open orders `0`건이었고 live `get_orders(status=open)` 기준도 `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: source-of-record `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1631` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_watchlists/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 account `ACTIVE`, cash `30,391.80 USD`, portfolio value `101,325.26 USD`, buying power `304,332.44 USD`였고 live continuity 기준 portfolio value `101,347.84 USD`, buying power `304,350.64 USD`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`가 유지됐다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1631-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 16:34 KST_
...
- Cancelled: 없음
- Position count observed by Alpaca MCP: scheduler-owned `get_all_positions` 기준 positions `33`건이었고, live `get_all_positions` 기준 count도 `33`건으로 유지됐다.
- Recent reconciliation scope: scheduler-owned `1551` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, live Alpaca MCP `get_account_info/get_all_positions/get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_watchlists/get_stock_latest_quote(feed=overnight, symbols=RGTI,PFE,QQQ)` continuity로 same-session budget closure와 current state를 재확인했다. source-of-record 기준 regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1551-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 15:53 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1531-after-hours-autopilot]]
...
- Recent reconciliation scope: scheduler-owned `1531` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, direct Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_watchlists` continuity로 same-session budget closure와 current state를 재확인했다. direct reconciliation 기준 regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1531-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 15:33 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1511-after-hours-autopilot]]
- Open/new: 없음. direct `get_orders(status=open)` 기준 open orders `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `1511` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, direct Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_watchlists` continuity로 same-session budget closure와 current state를 재확인했다. direct reconciliation 기준 regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1511-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 15:12 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1451-after-hours-autopilot]]
- Open/new: 없음. direct `get_orders(status=open)` 기준 open orders `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `1451` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, direct Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_watchlists` continuity로 same-session budget closure와 current state를 재확인했다. direct reconciliation 기준 regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1451-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 14:53 KST_

## 최신 after-hours-autopilot reconciliation

- Run: [[2026-06-17-1431-after-hours-autopilot]]
- Open/new: 없음. direct `get_orders(status=open)` 기준 open orders `0`건이었다.
- Filled: 이번 cycle 신규 fill 없음. same-session `client_order_id=ah-20260617-1331-sell-rgti-01`, `ah-20260617-1351-sell-pfe-01` 두 건은 모두 filled로 유지됐다. `get_orders(status=all, after=2026-06-16T20:00:00-04:00)` 및 `get_account_activities(activity_types=[FILL], after=2026-06-16T20:00:00-04:00)` 기준 same-session after-hours submitted orders/fills는 모두 `2`건이다.
- Cancelled: 없음
- Position count observed by Alpaca MCP: live `get_all_positions` 기준 positions `33`건이었다.
- Recent reconciliation scope: scheduler-owned `1431` core/research preflight를 source-of-record로 사용했고 Alpaca core `market_closed`는 expected nonblocking으로 처리했다. submit-boundary source-of-record는 같은 preflight의 passing account/positions/orders/activity/quote rows였고, direct Alpaca MCP `get_clock/get_account_info/get_all_positions/get_orders(status=open)/get_orders(status=all, after=2026-06-16T20:00:00-04:00)/get_order_by_client_id/get_account_activities(activity_types=[FILL])/get_watchlists` continuity로 same-session budget closure와 current state를 재확인했다. direct reconciliation 기준 regular market closed, account `ACTIVE`, open orders `0`, watchlists `0`, `PFE qty=2`, `qty_available=2`, `RGTI qty=27`를 재확인했고 separate after-hours session submitted count는 계속 `2/2`로 닫혀 있었다.
- Orders submitted/replaced/cancelled/closed by this workflow: 0 / 0 / 0 / 0.
- Source note: `wiki/trade-ledger/positions/2026-06-17-1431-after-hours-autopilot-post-trade.json`

_Last updated: 2026-06-17 14:32 KST_
