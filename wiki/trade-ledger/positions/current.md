...
- Run: [[2026-07-23-1851-after-hours-autopilot]]
- Open/new: 없음. scheduler-owned `1851` preflight와 live `get_orders(status=open)` 기준 open orders `0`이다.
