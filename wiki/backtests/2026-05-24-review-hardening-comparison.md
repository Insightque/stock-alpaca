...
- 기준 데이터: `wiki/raw/sources/2026-05-24-expanded-six-month-3h-simulation-data.json`
- 개선 후 계산 데이터: `wiki/raw/sources/2026-05-24-review-hardening-expanded-policy-data.json`
